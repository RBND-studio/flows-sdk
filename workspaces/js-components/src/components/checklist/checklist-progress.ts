...
export const ChecklistProgress = (props: Props): TemplateResult => {
  return html`
    <div class="flows_basicsV2_checklist_progress">
      <p class="flows_basicsV2_checklist_progress_text">
        ${props.completedItems} / ${props.totalItems}
      </p>
      <div
        class="flows_basicsV2_checklist_progress_bar"
        aria-valuemin=${0}
      ...
      >
        <div
          class="flows_basicsV2_checklist_progress_bar_filled"
